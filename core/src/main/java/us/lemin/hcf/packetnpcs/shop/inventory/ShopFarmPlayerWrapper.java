...
public class ShopFarmPlayerWrapper extends PlayerInventoryWrapper {
    private final HCF plugin;

    public ShopFarmPlayerWrapper(HCF plugin) {
        super("Shop", 6);
        this.plugin = plugin;
    }
    ...
    private void format(Player player, InventoryWrapper inventoryWrapper) {
        ...
        shopNPCManager.getShopFarming().forEach((string, shopItem) -> {
